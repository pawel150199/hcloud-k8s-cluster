...
The SSH key pairs the nodes use between themselves are **generated by the
module** (`tls_private_key`) and injected through cloud-init — you never pass
them in. See [Architecture §2.5](02-architecture.md#25-ssh-key-model).
